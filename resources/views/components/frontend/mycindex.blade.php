                ...
                <div class="row align-items-center">
                    <div class="col-lg-6">
                        <div class="hero_content hero_content2">
                            <h3 class="wow fadeInUp text-white" data-wow-delay="0.1s" data-wow-duration="1.1s"> Minimum Order <span> H-2</span> </h3>
                        ...
                        <div class="single_shipping d-flex align-items-center">
                            ...
                            <div class="shipping_text">
                                ...
                                <p>Makanan yang sudah dibayarkan 
                                    ...
                                    <br>dikembalikan dan ganti tanggal</p>
                            </div>
                        </div>
                    </div>
                </div>
