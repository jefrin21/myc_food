<x-layout_backend>
    ...
    @endsection
                                ...
                                <div class="col-12">
                                    <div class="card">
                                        <div class="card-body">            
                                            ...
                                            <p class="text-muted mb-4 font-13">Bootstrap-wysihtml5 is a javascript
        ...
        <!--Wysiwig js-->
        <script src="assets_backend/plugins/tinymce/tinymce.min.js"></script>
        <script src="assets_backend/pages/form-editor.js"></script>
