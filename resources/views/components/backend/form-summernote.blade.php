<x-layout_backend>
    ...
    <head>
        ...
        <!-- Summernote css -->
        <link href="assets_backend/plugins/summernote/summernote-bs4.css" rel="stylesheet" />
    ...
    @endsection
                                ...
                                <div class="col-12">
                                    <div class="card">
                                        <div class="card-body">
                                            ...
                                            <p class="text-muted mb-4 font-13">Super simple wysiwyg editor on bootstrap</p>
        ...
        <script src="assets_backend/pages/form-summernote.js"></script>
