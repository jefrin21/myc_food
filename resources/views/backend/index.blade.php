                            ...
                            <ul class="list-inline float-right mb-0">
                                ...
                                >
                                    ...
                                    >
                                        English
                                        <img
                                            src="assets_backend/images/flags/us_flag.jpg"
                                            class="ml-2"
                                            height="16"
                                            alt=""
                                        />
                                    ...
                                    >
                                        <a class="dropdown-item" href="#"
                                            ><img
                                                src="assets_backend/images/flags/italy_flag.jpg"
                                                alt=""
                                                height="16"
                                            /><span> Italian </span></a
                                        >
                                        <a class="dropdown-item" href="#"
                                            ><img
                                                src="assets_backend/images/flags/french_flag.jpg"
                                                alt=""
                                                height="16"
                                            /><span> French </span></a
                                        >
                                        <a class="dropdown-item" href="#"
                                            ><img
                                                src="assets_backend/images/flags/spain_flag.jpg"
                                                alt=""
                                                height="16"
                                            /><span> Spanish </span></a
                                        >
                                        <a class="dropdown-item" href="#"
                                            ><img
                                                src="assets_backend/images/flags/russia_flag.jpg"
                                                alt=""
                                                height="16"
                                            /><span> Russian </span></a
                                        >
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-3">
                                    <div class="card">
                                        <div class="card-body">
                                            <div
                                                class="dropdown d-inline-block float-right"
                                            >
                                                <a
                                                ...
                                                >
                                                    <i
                                                        class="fas fa-ellipsis-v font-20 text-muted"
                                                    ></i>
                                                </a>
                                                <div
                                            ...
                                            >
                                                <li
                                                    class="mb-2 list-inline-item text-muted font-13"
                                                >
                                                    <i
                                                        class="mdi mdi-label text-success mr-2"
                                                    ></i
                                                    >Active
                                                </li>
                                                <li
                                                ...
                                                >
                                                    <i
                                                        class="mdi mdi-label text-danger mr-2"
                                                    ></i
                                                    >Complete
                                                </li>
                                                <li
                                                ...
                                                >
                                                    <i
                                                        class="mdi mdi-label text-warning mr-2"
                                                    ></i
                                                    >Panding
                                                </li>
                                            </ul>
                                    ...
                                    <div class="card">
                                        <div class="card-body">
                                            <div class="row mb-3">
                                                <div class="col-sm-6">
                                                    <p
                                                        class="mb-0 text-muted font-13"
                                                    >
                                                        <i
                                                            class="mdi mdi-album mr-2 text-warning"
                                                        ></i
                                                        >New Leads
                                                    </p>
                                                </div>
                                                <div class="col-sm-6">
                                                    ...
                                                    >
                                                        <i
                                                            class="mdi mdi-album mr-2 text-danger"
                                                        ></i
                                                        >New Leads Target
                                                    </p>
                                                </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-xl-4 col-lg-6">
                                    ...
                                    <div class="card">
                                        <div class="card-body">
                                            <div
                                                class="d-sm-flex align-self-center"
                                            >
                                                <img
                                                    src="assets_backend/images/widgets/code.svg"
                                                    alt=""
                                                    class=""
                                                    height="100"
                                                />
                                        ...
                                        <div class="card-body p-0">
                                            ...
                                            >
                                                <p class="mb-0 font-18">
                                                    <i
                                                        class="mdi mdi-clock-outline font-20"
                                                    ></i>
